...
void button::button_pressed(){
    ...
    if(live_mode){
        if(t==haltype::HAL_BIT_IN){
            value_pressed = (*pin_bit->pin) ? QChar('1') : QChar('0');
        }
        if(t==haltype::HAL_BIT_OUT){
        ...
        if(t==haltype::HAL_FLOAT_IN){
            value_pressed=QString::number(*pin_float->pin);
        }
        if(t==haltype::HAL_FLOAT_OUT){
        ...
        if(t==haltype::HAL_S32_IN){
            value_pressed=QChar(static_cast<ushort>(*pin_s32->pin));
        }
        if(t==haltype::HAL_S32_OUT){
        ...
        if(t==haltype::HAL_U32_IN){
            value_pressed=QChar(static_cast<ushort>(*pin_u32->pin));
        }
        if(t==haltype::HAL_U32_OUT){
...
void button::button_released(){
    ...
    if(live_mode){
        if(t==haltype::HAL_BIT_IN){
            value_released= (*pin_bit->pin) ? QChar('1') : QChar('0');
        }
        if(t==haltype::HAL_BIT_OUT){
        ...
        if(t==haltype::HAL_FLOAT_IN){
            value_released=QString::number(*pin_float->pin);
        }
        if(t==haltype::HAL_FLOAT_OUT){
        ...
        if(t==haltype::HAL_S32_IN){
            value_released=QChar(static_cast<ushort>(*pin_s32->pin));
        }
        if(t==haltype::HAL_S32_OUT){
        ...
        if(t==haltype::HAL_U32_IN){
            value_released=QChar(static_cast<ushort>(*pin_u32->pin));
        }
        if(t==haltype::HAL_U32_OUT){
